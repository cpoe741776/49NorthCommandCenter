        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                <label className="text-sm font-semibold text-gray-600">Agency/Entity:</label>
              ...
              <div>
                ...
                <p className="text-base text-gray-900 mt-1 break-words">{bid.emailFrom || 'Unknown'}</p>
              </div>
              <div>
                <label className="text-sm font-semibold text-gray-600">Email Date Received:</label>
                <p className="text-base text-gray-900 mt-1">{bid.emailDateReceived || 'Unknown'}</p>
              </div>
              <div>
                <label className="text-sm font-semibold text-gray-600">Email Domain:</label>
                <p className="text-base text-gray-900 mt-1">{bid.emailDomain || 'Unknown'}</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-base text-gray-900 mt-1">{bid.country || 'Unknown'}</p>
              </div>
              <div>
                <label className="text-sm font-semibold text-gray-600">Status:</label>
                <p className="text-base text-gray-900 mt-1">{bid.status || 'Unknown'}</p>
              </div>
              <div>
                <label className="text-sm font-semibold text-gray-600">Date Added:</label>
                <p className="text-base text-gray-900 mt-1">{bid.dateAdded || 'Unknown'}</p>
              </div>
              <div>
